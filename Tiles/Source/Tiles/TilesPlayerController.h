...
#include "TilesPlayerController.generated.h"
...
UCLASS()
class ATilesPlayerController : public APlayerController
{
	GENERATED_BODY()

public:
	ATilesPlayerController();
...
protected:
	...
	/** Input handlers for SetDestination action. */
	void OnMoveForwardTriggered();
	void OnMoveBackwardTriggered();
